...
function Atr_SetupStackingFrame ()
  ...
  if (_G["Atr_StackList1"] == nil) then
    ...
    for n = 1, kStackList_LinesToDisplay do
      local y = -5 - ((n-1)*16);
      line = CreateFrame("BUTTON", "Atr_StackList"..n, Atr_Stacking_List, BackdropTemplateMixin and "Atr_StackingEntryTemplate");
...
function Atr_SetupShpListsFrame()
  ...
  if (_G["Atr_ShpList1"] == nil) then
    ...
    for n = 1, kShpLists_LinesToDisplay do
      ...
      line = CreateFrame("BUTTON", "Atr_ShpList"..n, Atr_ShpList_Frame, BackdropTemplateMixin and "Atr_ShpListsEntryTemplate");
      line:SetPoint("TOP", 0, y);
    end
  end
...
function ShowInterfaceOptionsMask()
  ...
  if (gInterfaceOptionsMask == nil) then
    gInterfaceOptionsMask = CreateFrame ("Frame", "Atr_Mask_StdOptions", _G["InterfaceOptionsFrame"], BackdropTemplateMixin and "Atr_Mask_StdOptionsTempl");
