...
local function ScanTip(itemLink,itemLevel,show)
	...
	if type(tipCache[itemLink].ilevel)=="nil"then -- or not tipCache[itemLink].cached then
		...
		if not scanningTooltip then
			anchor=CreateFrame("Frame", nil, self, BackdropTemplateMixin and "BackdropTemplate")
			anchor:Hide()
			scanningTooltip = _G.CreateFrame("GameTooltip", "LibItemUpgradeInfoTooltip", nil, BackdropTemplateMixin and "GameTooltipTemplate")
		end
...
do
	...
	function lib:_CheckUpgradeTable(itemLink)
		...
		if not debugFrame then
			debugFrame = _G.CreateFrame("frame", nil, self, BackdropTemplateMixin and "BackdropTemplate")
			debugFrame:Hide()
		...
		if not debugTooltip then
			debugTooltip = _G.CreateFrame("GameTooltip", "LibItemUpgradeInfoDebugTooltip", nil, BackdropTemplateMixin and "GameTooltipTemplate")
